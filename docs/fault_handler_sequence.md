# Configuring the Microsoft Azure Storage Fault Handler Sequence

Following is a sample proxy service and fault handler sequence you can use as a starting point for handling faults when integrating with Microsoft Azure Storage. Customize this sample to match your requirements.

**Sample Proxy**
```xml
<proxy xmlns="http://ws.apache.org/ns/synapse" name="MicrosoftAzureStorage_sampleProxy" transports="https,http" statistics="disable" trace="disable" startOnLoad="true">
  <target>
